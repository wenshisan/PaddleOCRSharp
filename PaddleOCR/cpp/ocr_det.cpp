...
void DBDetector::LoadModel(const std::string &model_dir) {
  ...
  //std::cout << " LoadModel SwitchUseFeedFetchOps" << endl;
  // use zero_copy_run as default
  config.SwitchUseFeedFetchOps(false);
  // true for multiple input
  config.SwitchSpecifyInputNames(true);
 /* std::cout << " LoadModel SwitchIrOptim" << endl;*/
  config.SwitchIrOptim(true);

  config.EnableMemoryOptim();
   config.DisableGlogInfo();
 /* std::cout << " LoadModel CreatePredictor" << endl;*/
  try
  {
  ...
  {
   /*   std::cout <<"LoadModel exception " << e.what() << endl;*/
  }
 /* std::cout << " LoadModel CreatePredictor end" << endl;*/
}
